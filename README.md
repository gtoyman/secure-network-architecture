...
For secure access to your network from the outside, use MESHNET. (meshnet breaks the linux gateway to the lan so you must use that one a different machine on the lan. With ssh-tunneling you can access all your hardware on your lan.
